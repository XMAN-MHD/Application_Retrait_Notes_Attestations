...
<!-- IMPORT CONTROLLERS FOR THE VIEW DELETE DOCUMENTS... -->

<?php


    include("../../controllers/interface_supprimer_documents/controller_supprimer.php"); 

?>

<!-- VIEW OF THE PROFILE | DELETION | DELETE DOCUMENTS -->
...
<!-- head section -->
    ...
    <head>
        ...
        /* nav section */
            ...
            body #middle-content nav #supprimer_documents_link  
            {
        ...
        /* main section */
            ...
            body #middle-content main form 
            {
                grid-area: form;
                display: grid;    
                grid-template-areas: "form-section-one" "form-section-two" "form-section-three" "form-section-four" "form-section-six";
                row-gap: 2px;
            }
                ...
                <main>
                    ...
                    <section id="main-content">
                        ...
                        <!-- icon image section -->
                            ...
                            <img src="../images/delete.png" alt="fill_form">
                        ...
                        <!-- form section -->
                            ...
                            <form action="" method="post" enctype="multipart/form-data" id="formulaire">
                                ...
                                <?php
                                        if ($is_form_sent == true && $errors_message == "DOCUMENTS INTROUVABLES") 
                                        {
                                        # documents not found...
                                            echo "$errors_message";
                                        }
                                        ...
                                        if ($is_form_sent == true && $errors_message == "DOCUMENTS NON SUPPRIMÉS") 
                                        {
                                        # no deletion...
                                            echo "$errors_message";
                                        }
                                        if($success_message == "DOCUMENTS SUPPRIMÉS")
                                        {
                                            # document deleted...
                                            echo 
                                            '   <p style="color: rgb(12, 173, 80);">
                                                    DOCUMENTS SUPPRIMÉS AVEC SUCCÉS
                                                </p>
                                            ';
                                        }   
                                ...
                                <section class="form-sections" id="form-section-six">
                                    ...
                                    <p>
                                        ...
                                        <input type="submit" value="supprimer" id="button">
