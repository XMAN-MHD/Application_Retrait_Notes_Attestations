...
<!-- IMPORT CONTROLLERS FOR THE VIEW SEARCH GRADES... -->

<?php

    include("../../controllers/interface_recherche_notes/controller_rechercher_notes.php");
    
?>

<!-- VIEW OF THE PROFILE | GRADES | SEARCH -->
    ...
    <head>
        ...
        /* main section */
            ...
            body #middle-content main form 
            {
                grid-area: form;
                display: grid;    
                grid-template-areas: "form-section-one" "form-section-two" "form-section-three" "form-section-four" "form-section-five";
                row-gap: 2px;
            }
                        ...
                        <!-- form section -->
                            ...
                            <form action="" method="post" enctype="multipart/form-data" id="formulaire">
                                ...
                                <section class="form-sections" id="section-feedback-errors" id="form-section-one">
                                    ...
                                    <?php 
                                        if ($is_form_sent == true && $errors_message == "NOTES INTROUVABLES") 
                                        {
                                        # documents not found...
                                            echo "$errors_message";
                                        }
                                ...
                                <section class="form-sections" id="form-section-five">
