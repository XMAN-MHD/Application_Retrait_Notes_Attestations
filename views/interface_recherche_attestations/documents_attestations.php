...
<!-- IMPORT CONTROLLERS FOR THE CERTIFICATIONS DOCUMENTS... -->

<?php

    include("../../controllers/interface_recherche_attestations/controller_documents_attestations.php");
    
?>

<!-- VIEW OF THE PROFILE | CERTIFICATIONS | DOCUMENTS -->
                            ...
                            <form action="" method="post" enctype="multipart/form-data" id="formulaire">
                                ...
                                <section class="form-sections" id="form-section-two" id="btn-pdf-tag">
                                    ...
                                    <p id="download-buttons-container">
                                        ...
                                        <a href="<?= $certifications_pdf ?>" id="download-buttons-tag">
                                    ...
                                    <p id="download-buttons-container">
                                        ...
                                        <a href="<?= $certifications_img ?>" id="download-buttons-tag" id="btn-jpg-tag">
